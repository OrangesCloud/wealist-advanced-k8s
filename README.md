...
| 서비스 | 기술 | 포트 | 설명 |
|--------|------|------|------|
| **Frontend** | React + Vite | 5173 | 웹 UI |
| **Auth Service** | Spring Boot | 8081 | JWT 토큰 관리, OAuth 인증 |
| **User Service** | Spring Boot | 8080 | 사용자, 워크스페이스 관리 |
| **Board Service** | Go + Gin | 8082 | 프로젝트, 보드, 댓글 관리 |
| **Chat Service** | Go + Gin | 8083 | 실시간 채팅 (WebSocket) |
| **Noti Service** | Spring Boot | 8084 | 알림 관리 (SSE) |

### 데이터베이스

| 서비스 | 데이터베이스 | 주요 테이블 |
|--------|-------------|------------|
| User Service | user_db | users, workspaces, workspace_members, user_profiles |
| Board Service | board_db | projects, boards, comments, field_options, attachments |
| Chat Service | chat_db | chats, messages, chat_participants, user_presences |
...
### Backend
- **Go 1.24** - Board, Chat Service
- **Spring Boot 3** - User, Auth, Noti Service
...
**상황:** 협업 플랫폼의 여러 도메인 (사용자, 프로젝트, 채팅, 알림)을 어떻게 구성할 것인가?
