...
| 서비스 | 기술 | 호스트 포트 | 컨테이너 포트 | 설명 |
|--------|------|------------|--------------|------|
| **Frontend** | React + Vite + TypeScript | 3000 | 5173 | 웹 UI |
| **Auth Service** | Spring Boot 3 + Java 21 | 8080 | 8090 | JWT 토큰 관리, OAuth 인증 |
| **User Service** | Go 1.24 + Gin | 8090 | 8080 | 사용자, 워크스페이스 관리 |
| **Board Service** | Go 1.24 + Gin | 8000 | 8000 | 프로젝트, 보드, 댓글 관리 |
| **Chat Service** | Go 1.24 + Gin | 8001 | 8001 | 실시간 채팅 (WebSocket) |
| **Noti Service** | Go 1.24 + Gin | 8002 | 8002 | 알림 관리 (SSE) |
